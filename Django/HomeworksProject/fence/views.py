...
class FenceDefinitionView(TemplateView):
    ...
    def generate_picture(self, ff, xmax, ymax):
        ...
        ax.set_title(f'Frame: {ff.frame_length:.3f} x {ff.frame_height:.3f}', size=8)
        col = 0
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            for item in framesList:
                ...
                graphic = self.generate_picture(ff, xmax, ymax)
            ...
            if raw_plank_length:
                ...
                rawList = []
            context = {'form':form, 'images': images, 'rawNum': len(rawList), 'rawList': rawList}    
